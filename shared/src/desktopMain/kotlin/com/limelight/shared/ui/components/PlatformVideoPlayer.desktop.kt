...
@Composable
actual fun PlatformVideoPlayer(streamingUrl: String, authConfig: ImmichConnectionConfig, isPlaying: Boolean, onDurationKnown: (Long) -> Unit, onPositionChanged: (Long) -> Unit, modifier: Modifier) {
    onDurationKnown(1)
